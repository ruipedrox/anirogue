...
-- Stats per level
local statsPerLevel = {
	[1] = { projectileCount = 1, damagePercent = 0.75, size = 1.0, cooldown = 3.0 },
	[2] = { projectileCount = 1, damagePercent = 0.90, size = 1.0, cooldown = 2.8 },
	[3] = { projectileCount = 2, damagePercent = 1.05, size = 1.5, cooldown = 2.6 },
	[4] = { projectileCount = 2, damagePercent = 1.25, size = 1.5, cooldown = 2.4 },
	[5] = { projectileCount = 3, damagePercent = 1.50, size = 2.0, cooldown = 2.0 }
}
...
local function fireGetsuga(player, level)
	...
	if targetPos then
		-- Aim at enemy (TOP-DOWN: ignore Y axis)
		direction = (targetPos.Position - hrp.Position) * Vector3.new(1, 0, 1)
