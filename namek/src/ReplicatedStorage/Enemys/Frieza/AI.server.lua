...
local function fireDeathBeam(targetPos)
	...
	SFXHelper.playAt(root, DEATH_BEAM_SFX_ID, 0.7, { minDist = 10, maxDist = 80, lifetime = 2 })
...
local function fireDestructoDisc(targetPos)
	...
	SFXHelper.playAt(root, 117381389817040, 0.7, { minDist = 10, maxDist = 80, lifetime = 3 })
	...
	task.delay(2, function()
		...
		SFXHelper.playAt(root, 139665895552627, 0.7, { minDist = 10, maxDist = 80, lifetime = 2 })
			...
			if bestRoot then
				...
				elseif attackIndex == 3 and superNovaModel then
					...
					if attackAnim then
						...
						SFXHelper.playAt(root, NORMAL_SFX_ID, 0.7, { minDist = 10, maxDist = 70, lifetime = 2 })
						isAttacking = false
					else
