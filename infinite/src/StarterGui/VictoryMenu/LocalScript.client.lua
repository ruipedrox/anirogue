-- VictoryMenu LocalScript (Infinite Mode)
-- Victory screen is NOT used in infinite mode (endless waves, only death ends run)
-- This file remains for potential future use but is effectively disabled
...
-- In infinite mode, there is no victory condition - only death or manual exit
-- This menu will not be shown; keeping minimal structure for compatibility
...
-- NOTE: Infinite mode uses milestone rewards instead of end-of-run victory
-- Players progress indefinitely until death
